...
public class ItemPearlFlintAndSteel extends Item
{
	public ItemPearlFlintAndSteel(int par1)
	{
		super(par1);
		this.maxStackSize = 1;
		setMaxDamage(64);
	...
	public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
	{
		...
		if (i1 == 0)
		{
			...
			par3World.setBlock(par4, par5, par6, Main.PearlFire.blockID);
		}
	...
	{
		return Reference.MOD_ID + ":" + getUnlocalizedName();
	}
}
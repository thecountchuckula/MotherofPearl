...
public class mopItem8 extends ItemArmor {

    public mopItem8(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4, String type) {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, int slot, int layer) {
        return ModInfo.MOD_ID.toLowerCase() + ":" + "pearl_2.png";
    }

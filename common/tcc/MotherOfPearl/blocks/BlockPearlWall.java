...
public class BlockPearlWall extends BlockWall
{

	

public BlockPearlWall(int par1, Block par2Block) {
		super(par1, par2Block);
		// TODO Auto-generated constructor stub
        this.setUnlocalizedName("pearlstoneWall");
...
public int idDropped(int par1, Random par2Random, int par3) {
    return ModBlocks.pearlWall.blockID;
}
/**

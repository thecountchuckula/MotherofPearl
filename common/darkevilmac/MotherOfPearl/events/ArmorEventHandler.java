...
public class ArmorEventHandler 
{
	...
	public void livingUpdateEvent(LivingEvent.LivingUpdateEvent event)
	{
		if(event.entityLiving instanceof EntityPlayer)
		{
			...
			jumpingAmount = EnchantmentHelper.getEnchantmentLevel(ModEnchantments.jumping.effectId, stack_legs);
			...
			swiftnessAmount = EnchantmentHelper.getEnchantmentLevel(ModEnchantments.swiftness.effectId, stack_feet);
			...
			angelwingsAmount = EnchantmentHelper.getEnchantmentLevel(ModEnchantments.angelwings.effectId, stack_torso);
			...
			nightvisionAmount = EnchantmentHelper.getEnchantmentLevel(ModEnchantments.nightvision.effectId, stack_head);

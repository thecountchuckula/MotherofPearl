...
public class ModInfo {
	...
	public static EnumArmorMaterial blackPearlMaterial = 
			EnumHelper.addArmorMaterial("PearlArmor", 21, new int[] { 3, 9, 6, 3 }, 25);
	public static EnumArmorMaterial shellMaterial = 
			EnumHelper.addArmorMaterial("ShellArmor", 11, new int[] { 1, 5, 3, 2 }, 8);
	...
	public static void crafting() {
		...
		GameRegistry.addRecipe(new ItemStack(bootsPearl, 1), 
				...
				'x', pearl,
				'y', ingotIron);
		GameRegistry.addRecipe(new ItemStack(bootsBlackPearl, 1), 
				"x x", 
				"y y", 
				'x', blackPearl,
				'y', ingotIron);
		...
		GameRegistry.addRecipe(new ItemStack(braShell, 1), 
				...
				'x', string,
				'y', shell);
		GameRegistry.addRecipe(new ItemStack(skirtGrass, 1), 
				"xxx",
				"ypy",
				"ggg",
				'x', string,
				...
				'p', pearl,
				'g', wheat);
		GameRegistry.addRecipe(new ItemStack(crownShell, 1), 
				"yyy",
				"yxy",
				'x', string,
				'y', shell);
		GameRegistry.addRecipe(new ItemStack(hempSandals, 1), 
				"x x",
				"g g",
				'x', string,
				'g', wheat);
		GameRegistry.addRecipe(new ItemStack(chestplatePearl, 1), 
				...
				'x', pearl,
				'y', ingotIron);
		GameRegistry.addRecipe(new ItemStack(chestplateBlackPearl, 1), 
				"x x", 
				"yxy", 
				"yyy", 
				'x', blackPearl,
		...
		GameRegistry.addRecipe(new ItemStack(helmetPearl, 1),
				...
				'x', pearl,
				'y', ingotIron);
		GameRegistry.addRecipe(new ItemStack(helmetBlackPearl, 1),
				"xyx", 
				"y y", 
				'x', blackPearl,
				'y', ingotIron);
		...
		GameRegistry.addRecipe(new ItemStack(leggingsPearl, 1), 
				...
				'x', pearl,
				'y', ingotIron);
		GameRegistry.addRecipe(new ItemStack(leggingsBlackPearl, 1), 
				"yxy", 
				"y y", 
				"x x", 
				'x', blackPearl,
		...
		GameRegistry.addRecipe(new ItemStack(shovelPearl, 1), 
				...
				'x', stick,
				'y', pearl);
		GameRegistry.addRecipe(new ItemStack(shovelBlackPearl, 1), 
				"y", 
				"x", 
				"x", 
				'x', stick,
		...
		GameRegistry.addRecipe(new ItemStack(swordPearl, 1), 
				...
				'x', stick,
				'y', pearl);
		GameRegistry.addRecipe(new ItemStack(swordBlackPearl, 1), 
				"y", 
				"y", 
				"x", 
				'x', stick,
